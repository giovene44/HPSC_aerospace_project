                     ...
                     Real &l2_error, Real &time_speedup)
{
    ...
    solver.solve<1>(rhs_delta, computed_par, y_handler, true);
    ...
    solver.solve<1>(rhs_delta, computed_ser, y_handler, false);
...
int main()
{
    ...
    printf("=================================================\n");
    printf("Y-DIRECTION MOMENTUM SPLITTING CONVERGENCE STUDY\n");
    printf("=================================================\n\n");
    ...
    for (Dim N : grid_sizes)
    {
        ...
        bool success = solve_and_check(solver, rhs_1, vector_1, rhs_2, vector_2, g, y_handler, l2_error, time_speedup);
    ...
    printf("=================================================\n");
    printf("Results written to: convergence_momentum_y.txt\n");
