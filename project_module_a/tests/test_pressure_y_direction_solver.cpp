                     ...
                     Real &l2_error, double &elapsed_seconds, bool use_omp)
{
    ...
    solver.solve_pressure<1>(rhs, computed_sol, y_handler, use_omp);
...
int main()
{
    ...
    printf("=================================================\n");
    printf("Y-DIRECTION PRESSURE SPLITTING CONVERGENCE STUDY\n");
    printf("=================================================\n\n");

    std::ofstream outfile("convergence_pressure_y.txt");
    ...
    for (Dim N : grid_sizes)
    {
        ...
        bool ok_serial = solve_and_check(solver_serial, rhs_serial, scalar, g, y_handler, l2_error_serial, t_serial, /*use_omp=*/false);
        bool ok_parallel = solve_and_check(solver_parallel, rhs_parallel, scalar, g, y_handler, l2_error_parallel, t_parallel, /*use_omp=*/true);
    ...
    printf("=================================================\n");
    printf("Results written to: convergence_pressure_y.txt\n");
