...
public:
    ...
    std::vector<Real> forcing(Real x, Real y, Real z, Real t) const
    {
        ...
        // f_x component
        result[0] = cos_t * sin_x * sin_y * sin_z + (3.0f / Re) * sin_t * sin_x * sin_y * sin_z + k_val * u_val + (3.0f / Re) * sin_x * sin_y * (sin_z - cos_z);

        // f_y component
        result[1] = cos_t * cos_x * cos_y * cos_z + (3.0f / Re) * sin_t * cos_x * cos_y * cos_z + k_val * v_val - (3.0f / Re) * cos_x * cos_y * (sin_z - cos_z);

        // f_z component
        result[2] = cos_t * cos_x * sin_y * (sin_z + cos_z) + (3.0f / Re) * sin_t * cos_x * sin_y * (sin_z + cos_z) + k_val * w_val - (3.0f / Re) * cos_x * sin_y * (cos_z + sin_z);
