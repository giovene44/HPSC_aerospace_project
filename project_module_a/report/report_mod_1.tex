...
The results confirm that the solver achieves second-order accuracy in space, as shown in Figure~\ref{fig:convergence_space} consistent with the theoretical properties of the discretization scheme employed.
...
Similar convergence tests have been performed for the time discretization (Figure~\ref{fig:convergence_time}) underlining the #TO DO.
\begin{figure}[h!]
    \centering
    % \includegraphics[width=0.6\textwidth]{convergence_space.png} % nome del file immagine
